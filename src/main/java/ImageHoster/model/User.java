...
public class User {
    ...
    // then all the records in 'images' table associated to that particular record in 'users'
    // table will be deleted first and then the record in the 'users' table will be deleted
    //FetchType is LAZY
